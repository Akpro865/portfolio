...
function About(){
	return (
		<>
		  <div className='mb-10 py-8 md:p-o' id='about'>
		  ...
		  <section className='homeHeight flex items-center relative'>
		    <SiJavascript className='absolute hidden md:block h-28 w-28 -top-[1px] right-[100px] text-yellow-50 bg-gray-200'/>   
		    <GiLeafSkeleton className='absolute h-9 w-9 text-green-500 -bottom-4 md:bottom-10 md:left-36 left-auto right-10 md:right-auto'/>
		    <section className='flex flex-col md:flex-row justify-between items-center'>
			    <div className='basis-1/2 flex justify-center items-center'>
			     <img src={profile2} alt='profile' className='h-[280px] w-96 object-cover rounded-xl'/>
			    </div>
			    <div className='basis-1/2'>
			      <p className='py-8 md:py-3 text-[18px] text-secondary'>Web Developer, with good knowledge and more than a year of self development experience, working in web technologies and Ui / Ux design delivering good work</p>
