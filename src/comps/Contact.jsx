	...
	return (
	  <section className='md:flex homeHeight justify-center items-center'>
		...
		<div className='flex flex-col basis-1/2'>
		  ...
		  <input placeholder='Fullname' className='w-[60%] text-black outline-green-400 my-2 pl-3 h-12 rounded-[8px] bg-gray-100'/>
		  <input placeholder='E-mail' className='w-[60%] text-black outline-green-400 my-2 pl-3 h-12 rounded-[8px] bg-gray-100'/>
		  <input placeholder='Place' className='w-[60%] text-black outline-green-400 my-2 pl-3 h-12 rounded-[8px] bg-gray-100'/>
		  <label className='font-medium my-1'>Tell breifly</label>
		  <textarea className='h-24 w-[60%] text-black my-2 rounded-[8px] bg-gray-100 outline-green-400 p-2'/>
		  <div>
